...
import 'package:dayla_flutter/features/dashboard/presentation/widgets/trip_details_tab.dart';
import 'package:dayla_flutter/features/dashboard/presentation/widgets/trip_overview_tab.dart';
    ...
    return Scaffold(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          TripOverviewTab(
            trip: trip,
            onInvite: () => _showInviteCollaborator(trip.id),
          ),
          TripDetailsTab(trip: trip),
        ],
      ),
    );
  }
